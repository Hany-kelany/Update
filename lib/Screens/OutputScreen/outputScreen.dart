...
import 'package:createachannel/Screens/SettingScreen/settings_screen.dart';
import 'package:createachannel/Screens/about%20screen/aboutScreen.dart';
              ...
              leading: Builder(
                builder: (context) => IconButton(
                  icon: Icon(
                    Icons.menu,
                    color:
                        Colors.black, // Set the color of the drawer icon here
                  ),
                        ...
                        child: CircleAvatar(
                          ...
                          child: Image.asset(
                            !_buttonClicked
                                ...
                                : 'assets/images/img_1.png', // Set the custom icon here
                          ),
                        ),
                      ),
                    ),
